    ...
    <main className="min-h-screen">
      ...
      <section className="mt-12 flex flex-wrap justify-center gap-12 xl:px-24 px-5">
        <ServiceCard
          ...
          imageUrl="/images/tarot-cards.jpg"
        />
      ...
      <section className="mt-[120px] px-8">
        ...
        <div className="xl:px-[400px] mt-5">
          ...
          <div className="text-white text-center mt-5">
            <Link to="/sobre-nosotros" className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
              Leer más
            </Link>
          </div>
        </div>
