...
import { SocialMediaLinks } from "../../components/ui/social-media-links/SocialMediaLinks";
    ...
    <main className="min-h-screen">
      ...
      <section className="flex flex-wrap items-center justify-center mt-20 gap-[100px]">
        ...
        <div className="px-3 xl:text-left text-center">
          <p className="text-[#17384E] font-[600] text-xl">Dirección</p>
          <p className="mt-5 font-[500] text-[18px]">Buenos Aires. Merlo.</p>
          ...
          <p className="mt-12 text-[#17384E] font-[600] text-xl">Redes sociales</p>
          <SocialMediaLinks />
        </div>
      </section>
    </main>
